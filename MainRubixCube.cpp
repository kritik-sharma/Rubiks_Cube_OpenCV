...
The code is protected against copy right laws,
any modification,distribution or usage of code for commercial
purpose is strictly prohibited [ lol _|_, ]
CREDITS
Nithin Prakash aka PAPU(chief code designer)
P ChandraKanth aka CC(chief code builder)
*/
